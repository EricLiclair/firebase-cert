...
# here i have given a particular path to create a folder 
  ...
  def create_os() :
      ...
      parent_dir = "firebase-cert\\app\\der1"
  ...
  def generate_certificate(self):
    ...
    im = Image.open("firebase-cert\\app\\der1\\Kotlin.png")
    draw= ImageDraw.Draw(im)
    myfont = ImageFont.truetype("firebase-cert\\app\\der1\\Google-sans-Font-Family\\ProductSans-Black.ttf",size = 50)
    myfont2 = ImageFont.truetype("firebase-cert\\app\der1\\Google-sans-Font-Family\\ProductSans-Regular.ttf",size = 25)
    W,H = im.size
